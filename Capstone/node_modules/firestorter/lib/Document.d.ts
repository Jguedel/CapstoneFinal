...
import { DocumentSource, ICollectionDocument, IDocumentOptions, IEnhancedObservableDelegate, Mode } from './Types';
...
declare class Document<T extends object = object> implements ICollectionDocument, IEnhancedObservableDelegate, IHasContext {
     ...
     */
    get ref(): Firebase.firestore.DocumentReference | undefined;
    set ref(ref: Firebase.firestore.DocumentReference | undefined);
    /**
     ...
     */
    get snapshot(): Firebase.firestore.DocumentSnapshot | undefined;
    /**
     ...
     * @private
     */
    _updateFromSnapshot(snapshot?: Firebase.firestore.DocumentSnapshot): void;
    /**
     * @private
     */
     ...
     * @private
     */
    protected _onSnapshot(snapshot: Firebase.firestore.DocumentSnapshot): void;
    /**
     * @private
     */
