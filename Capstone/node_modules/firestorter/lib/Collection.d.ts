...
import { CollectionQuery, CollectionSource, ICollectionDocument, ICollectionOptions, ICollection, IEnhancedObservableDelegate, Mode } from './Types';
...
declare class Collection<T extends ICollectionDocument = Document> implements ICollection<T>, IEnhancedObservableDelegate, IHasContext {
     ...
     */
    get ref(): Firebase.firestore.CollectionReference | undefined;
    set ref(ref: Firebase.firestore.CollectionReference | undefined);
    /**
     ...
     */
    get queryRef(): Firebase.firestore.Query | null | undefined;
    /**
    ...
    protected _ready(complete: any): void;
    protected _resolveRef(source: any): Firebase.firestore.CollectionReference;
    protected _resolveQuery(collectionRef: Firebase.firestore.CollectionReference, query?: CollectionQuery): Firebase.firestore.Query | null | undefined;
    /**
     * @private
     */
