 ...
 * Document Source.
 */
export declare type DocumentSource = Firebase.firestore.DocumentReference | string | (() => Firebase.firestore.DocumentReference | string | undefined) | undefined;
/**
 * Document options.
 */
 ...
 * Collection-source.
 */
export declare type CollectionSource = Firebase.firestore.CollectionReference | string | (() => Firebase.firestore.CollectionReference | string | undefined);
/**
 * Collection-query.
 */
export declare type CollectionQuery = ((ref: Firebase.firestore.CollectionReference) => Firebase.firestore.Query | null | undefined) | Firebase.firestore.Query;
/**
 * Collection options.
 */
