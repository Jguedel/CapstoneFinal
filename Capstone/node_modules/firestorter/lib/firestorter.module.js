...
import { observable, onBecomeUnobserved, onBecomeObserved, runInAction, toJS, reaction, autorun, makeObservable, computed } from 'mobx';
...
function makeFirestorterContext(config) {
    ...
    var globalFirebase = config.firebase;
    // Get app instance
    var globalFirebaseApp = config.app
        ? typeof config.app === 'string'
            ? globalFirebase.app(config.app)
            : config.app
        : globalFirebase.app();
    // Get firestore instance
    var globalFirestore = config.firestore || globalFirebaseApp.firestore();
    if (!globalFirestore) {
    ...
    try {
        ...
        throw new Error('Invalid `firebase` argument specified: `firebase.firestore.FieldValue.delete` does not exist');
    }
    return {
...
function mergeUpdateData(data, fields, hasContext) {
    ...
    var canonicalDelete = getFirebase(hasContext).firestore.FieldValue.delete();
...
var Document = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        runInAction(function () {
                            ...
                            if (_this.isVerbose) {
                                console.debug(_this.debugName + " - fetched: " + JSON.stringify(toJS(_this.data)));
                            }
                        });
                        this._ready(true);
                        return [3 /*break*/, 4];
    ...
    Document.prototype._updateRealtimeUpdates = function (force) {
        ...
        if (newActive && (!active || force)) {
            ...
            this.onSnapshotUnsubscribeFn = this.refObservable.get().onSnapshot(function (snapshot) { return _this._onSnapshot(snapshot); }, function (err) { return _this._onSnapshotError(err); });
        }
...
var Collection = /** @class */ (function () {
    ...
    function Collection(source, options) {
        ...
        runInAction(function () { return _this._updateRealtimeUpdates(true, true); });
    }
                    ...
                    case 0:
                        ...
                        this.createDocument(undefined, {
                            ...
                            snapshot: {
                                ...
                                id: '',
                                isEqual: function () { return false; },
                                metadata: undefined,
                                ref: undefined,
                            },
                        });
                        return [4 /*yield*/, ref.add(data)];
                    case 1:
                        ref2 = _a.sent();
                        return [4 /*yield*/, ref2.get()];
                    case 2:
                        snapshot = _a.sent();
    ...
    Collection.prototype._updateRealtimeUpdates = function (updateSourceRef, updateQueryRef) {
        ...
        this.onSnapshotUnsubscribe = ref.onSnapshot(function (snapshot) { return _this._onSnapshot(snapshot); }, function (err) { return _this._onSnapshotError(err); });
    };
    return Collection;
}());
    ...
    AggregateCollection.prototype.addObserverRef = function () {
        ...
        if (res === 1) {
            this.disposer = autorun(function () {
                ...
                runInAction(function () { return _this._updateQueries(queries); });
            });
        }
        return res;
    };
...
var GeoQuery = /** @class */ (function (_super) {
    ...
    function GeoQuery(source, options) {
        ...
        _this = _super.call(this, source, __assign({ filterBy: filterBy
                ...
                return geohashes.map(function (geohash) { return ({
                    ...
                    query: function (ref) { return ref.where(fieldPath, '>=', geohash[0]).where(fieldPath, '<', geohash[1]); },
                }); });
            } }, otherOptions)) || this;
    ...
    Object.defineProperty(GeoQuery.prototype, "region", {
        ...
        set: function (val) {
            var _this = this;
            runInAction(function () { return _this.regionObservable.set(val); });
        },
        enumerable: false,
        configurable: true
    });
...
export { AggregateCollection, Collection, Document, GeoQuery, Mode, calculateGeoDistance, decodeGeohash, encodeGeohash, flattenGeohashRange, flattenGeohashes, geoRegionToPoints, getFirebase, getFirebaseApp, getFirestore, getGeohashesForRadius, getGeohashesForRegion, initFirestorter, insideGeoRegion, isTimestamp, makeFirestorterContext, mergeUpdateData, metersToLatitudeDegrees, metersToLongitudeDegrees };
