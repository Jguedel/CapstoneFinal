...
import { ICollection, DocumentSource, IDocumentOptions, CollectionSource, ICollectionDocument, IEnhancedObservableDelegate } from './Types';
...
export interface IAggregateCollectionQuery {
    key: string;
    query: (ref: Firebase.firestore.CollectionReference) => Firebase.firestore.Query | null | undefined;
}
